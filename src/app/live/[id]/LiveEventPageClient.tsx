...
// Client half of /live/[id]: the server component resolves `stream` (static
// or Firestore-published) and calls notFound() if it doesn't exist; this
// just handles the countdown/interactive bits.
export default function LiveEventPageClient({ stream }: { stream: LiveStream }) {
