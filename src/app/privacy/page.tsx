        ...
        <div className="space-y-9 text-muted text-sm leading-relaxed">
          ...
          <section>
            ...
            <ul className="space-y-2 list-disc pl-5 marker:text-red-500/60">
              <li>
                <span className="text-foreground/90 font-medium">Account information</span> — such as your name, email
                address, and password (stored securely) when you create an account or sign in.
              </li>
              <li>
                <span className="text-foreground/90 font-medium">Payment information</span> — when you purchase or
              ...
              <li>
                <span className="text-foreground/90 font-medium">Usage and viewing activity</span> — content you watch,
                watch progress, watchlist items, searches, and interactions within the App.
              </li>
              <li>
                <span className="text-foreground/90 font-medium">Device and technical data</span> — device type,
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">3. How We Share Information</h2>
            <p className="mb-3">
            ...
            <ul className="space-y-2 list-disc pl-5 marker:text-red-500/60">
              <li>
                <span className="text-foreground/90 font-medium">Authentication &amp; database</span> — Google Firebase
                (authentication, Firestore) to manage accounts, watchlists, and viewing progress.
              </li>
              <li>
                <span className="text-foreground/90 font-medium">Payments</span> — our payment processor to securely
                handle transactions and confirm purchases.
              </li>
              <li>
                <span className="text-foreground/90 font-medium">Video delivery &amp; analytics</span> — providers that
                help us stream video and understand aggregate, anonymized app usage.
              </li>
              <li>
                <span className="text-foreground/90 font-medium">Legal</span> — authorities or third parties when
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">4. Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">5. Security</h2>
            <p>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">6. Your Rights &amp; Choices</h2>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">7. Children&apos;s Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">8. International Data Transfers</h2>
            <p>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">9. Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="font-display font-semibold text-xl text-foreground mb-3">10. Contact Us</h2>
            <p>
